...
//         price: PRICE.REGULAR,
//         description:
//           "Welcome to Last Train to Delhi. We are a progressive Indian restaurant in the beautiful Glebe community in Ottawa. Our speciality is Northern Indian food, classics like Murg Mahkini and some modern dishes like Crispy Shrimp. We are a small cozy restaurant, so make sure that you reserve through BookMyTable.",
//         images: [
...
//   const getRandomSeats = (num) => {
//     const seats = Math.floor(Math.random() * num) + 2;
//     return seats;
//   };
...
//     const fourSeats = getRandomSeats(2);
//     const twoSeats = getRandomSeats(4);
//     for (let i = 0; i < fourSeats; i++) {
//       dataArray.push({
//         seats: 4,
//         restaurant_id: restaurant.id,
//       });
//     }
//     for (let i = 0; i < twoSeats; i++) {
//       dataArray.push({
//         seats: 2,
//         restaurant_id: restaurant.id,
//       });
